            ...
            <div className='Container' >
                ...
                <div className='Row' >
                    ...
                    <div >
                        ...
                        <div>
                            <ul className="ftr-links-sub">
                                <li > <li>
                                    <img width="14" height="14" alt="" src="/images/i1.jpeg" className="photo" />

                                    <span >+94 112567876</span></li></li>
                                <li >
                                    <li>
                                        <img width="24" height="24" alt="" src="/images/i2.jpeg" className="photo" />
                                        <span >govisaviya@gmail.com</span></li></li>
                                <li >
                                    <li>
                                        <img width="24" height="24" alt="" src="/images/i3.jpeg" className="photo" /><span >No.200,Kiesly Road,Colombo 10,Sri Lanka.</span></li></li>
                    ...
                    <div>
                            <ul className="ftr-links-sub">
                                <li><li>
                                    <img width="14" height="14" alt="" src="/images/fb.jpeg" className="photo" /><span>govisaviya.facebook.com</span></li>
                                </li>
                                <li><li>
                                    <img width="24" height="24" alt="" src="/images/insta.jpeg" className="photo" />
                                    <span>govisaviya.facebook.instergram.com</span></li>
                                </li>
                              
                            <li><li>
                                <img width="24" height="24" alt="" src="/images/linkin.jpeg" className="photo" />
                                <span>govisaviya.linkedin.com</span></li>
                            </li>
                            
                                <li><li>
                            <img width="24" height="24" alt="" src="/images/tweet.jpeg" className="photo" />
