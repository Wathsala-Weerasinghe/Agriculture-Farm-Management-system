...
class editBudget extends Component {
    constructor(props){
        ...
        onSubmit = (e) =>{
            ...
            axios.put(`/cost/update/${id}`, data).then((res) =>{
                if(res.data.success){
                    alert("Income and Outcome Updated Successfully")
                    this.setState({
                        IncomeID:"",
                        IncomeActivity:"",
                        PricePerKg:"",
        ...
        axios.get(`/cost/${id}`).then((res) =>{
            if(res.data.success){
                this.setState({
                    ...
                    IncomeID:res.data.cost.IncomeID,
                    IncomeActivity:res.data.cost.IncomeActivity,
                    PricePerKg:res.data.cost.PricePerKg,
                    NetWeight:res.data.cost.NetWeight,
                    TotalIncome:res.data.cost.TotalIncome,
                    OutcomeID:res.data.cost.OutcomeID,
                    OutcomeActivity:res.data.cost.OutcomeActivity,
                    Payment:res.data.cost.Payment,
                    TotalOutcome:res.data.cost.TotalOutcome
    ...
    render() {
        return (
            <div className="col-md-8 mt-4 mx-auto">
                <h1 className="h3 mb-3 font-weight-normal">Update Income and Expense</h1>
