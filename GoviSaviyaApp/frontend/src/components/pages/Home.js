						...
						<div className="col-md-4 ">
							<div className="card shadow">
								...
								<div className="card-body">
									...
									<p>
										Customers can contact us to get the service for cultivating crops in their lands. Also we looking them after upto 2 weeks and if their any requirements we are providing them.
